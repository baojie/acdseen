...
- **五种界面语言**：English / 简体中文 / 日本語 / Español / Français，菜单「查看 → 界面语言」切换，不用重启即时生效，选择会记住；首次运行跟随系统 locale
...
Windows 95 外观还差哪些、哪些是刻意不做的，见 [`ref/win95-gaps.zh-CN.md`](ref/win95-gaps.zh-CN.md)，
对照的参考图在同一目录。
